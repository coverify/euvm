...
final class uvm_cmdline_processor: /*extends*/ uvm_report_object
{
  ...
  static public uvm_cmdline_processor get_inst() {
    return m_inst;
  }
  ...
  private string[] _m_argv;
  private string[] _m_plus_argv;
  private string[] _m_uvm_argv;
  ...
  final public string[] get_plusargs () {
    synchronized(this) {
      return _m_plus_argv;
    }
  }
  ...
  final public string[] get_uvm_args() {
    synchronized(this) {
      return _m_uvm_argv;
    }
  }
  ...
  final public size_t get_arg_matches (string _match, out string[] args) {
	...
	else if((arg.length >= len) && (arg[0..len] == _match))
	  args ~= arg;
      }
    }
    return args.length;
  ...
  final public int get_arg_value (string match, out string value) {
    synchronized(this) {
  ...
  static public string get_tool_name () {
  ...
  static public string  get_tool_version () {
  ...
  static public bool m_convert_verb(string verb_str,
...
public @property uvm_cmdline_processor uvm_cmdline_proc() {
