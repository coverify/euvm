...
// FIXME -- this file does not use the D port of VPI
...
// Does not seem to be ever get called
public int uvm_hdl_max_width() {
  vpiHandle ms;
  s_vpi_value value_s;
  value_s.format = vpiIntVal;
  value_s.value.integer = 0;
  // = { vpiIntVal, { 0 } };
  ms = vpi_handle_by_string_name("uvm_pkg::UVM_HDL_MAX_WIDTH", null);
  if(ms == null) return 1024;  /* If nothing else is defined, 
				  this is the DEFAULT */
